...
class OptionsFlowHandler(config_entries.OptionsFlowWithConfigEntry):
    ...
    async def async_step_init(
        ...
        max_concurrent_commands = options.get(
        ...
        options_schema = vol.Schema(
            {
                ...
                # 0 = use pyisyox auto-detection; >0 overrides. 1 keeps
                # strict serialization, which is the reliable ISY-994
                # posture; higher values are for healthy newer hubs.
                vol.Required(
                    CONF_MAX_CONCURRENT_COMMANDS, default=max_concurrent_commands
